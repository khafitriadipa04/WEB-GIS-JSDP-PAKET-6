...
lyr_TITIK_JSDP_5.set('fieldAliases', {'Name': 'Name', 'FolderPath': 'FolderPath', 'PopupInfo': 'PopupInfo', 'x': 'x', 'y': 'y', });
...
lyr_TITIK_JSDP_5.set('fieldImages', {'Name': 'TextEdit', 'FolderPath': 'TextEdit', 'PopupInfo': 'TextEdit', 'x': 'TextEdit', 'y': 'TextEdit', });
...
lyr_BatasWilayahJakartaUtara_2.set('fieldLabels', {'NAMOBJ': 'inline label - visible with data', 'REMARK': 'no label', 'WADMKC': 'no label', 'WADMKK': 'no label', 'WADMPR': 'no label', 'SHAPE_Leng': 'no label', 'SHAPE_Area': 'no label', });
lyr_BatasWilayahJakartaBarat_3.set('fieldLabels', {'NAMOBJ': 'inline label - visible with data', 'REMARK': 'no label', 'WADMKC': 'no label', 'WADMKK': 'no label', 'WADMPR': 'no label', 'SHAPE_Leng': 'no label', 'SHAPE_Area': 'no label', });
lyr_Jaringan_Perpipaan_4.set('fieldLabels', {'Name': 'inline label - visible with data', 'FolderPath': 'no label', 'PopupInfo': 'no label', });
lyr_TITIK_JSDP_5.set('fieldLabels', {'Name': 'inline label - visible with data', 'FolderPath': 'no label', 'PopupInfo': 'no label', 'x': 'no label', 'y': 'no label', });
