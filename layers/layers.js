...
lyr_TITIK_JSDP_5.set('fieldLabels', {'Name': 'header label - visible with data', 'FolderPath': 'header label - visible with data', 'PopupInfo': 'header label - visible with data', 'x': 'header label - visible with data', 'y': 'header label - visible with data', 'Survey Progres Pekerjaan  JSDP Paket 6 Submitted On': 'no label', 'Survey Progres Pekerjaan  JSDP Paket 6 Jenis Pekerjaan': 'no label', 'Survey Progres Pekerjaan  JSDP Paket 6 Status Pekerjaan': 'no label', 'Survey Progres Pekerjaan  JSDP Paket 6 Status Pekerjaan (Sudah selesai) - specify': 'no label', 'Survey Progres Pekerjaan  JSDP Paket 6 Status Pekerjaan (Belum ada pekerjaan) - specify': 'no label', 'Survey Progres Pekerjaan  JSDP Paket 6 Status Pekerjaan (Dalam Pekerjaan) - specify': 'no label', 'Survey Progres Pekerjaan  JSDP Paket 6 Foto pekerjaan': 'no label', 'Survey Progres Pekerjaan  JSDP Paket 6 Catatan': 'no label', 'Survey pemantauan lingkungan Submitted On': 'no label', 'Survey pemantauan lingkungan INSPEKSI LINGKUNGAN': 'no label', 'Survey pemantauan lingkungan INSPEKSI LINGKUNGAN (APD) - specify': 'no label', 'Survey pemantauan lingkungan INSPEKSI LINGKUNGAN (Kebersihan) - specify': 'no label', 'Survey pemantauan lingkungan INSPEKSI LINGKUNGAN (Rambu keselamatan) - specify': 'no label', 'Survey pemantauan lingkungan INSPEKSI LINGKUNGAN (Tempat Buangan Limbah) - specify': 'no label', 'Survey pemantauan lingkungan INSPEKSI LINGKUNGAN (Lainnya) - specify (1)': 'no label', 'Survey pemantauan lingkungan INSPEKSI LINGKUNGAN (Lainnya) - specify (2)': 'no label', 'Survey pemantauan lingkungan INSPEKSI LINGKUNGAN (Lainnya) - specify (3)': 'no label', 'Survey pemantauan lingkungan INSPEKSI LINGKUNGAN (Lainnya) - specify (4)': 'no label', 'Survey pemantauan lingkungan Kondisi Lapangan': 'no label', 'Survey pemantauan lingkungan Catatan': 'no label', 'SURVEY JSDP PAKET 6  Submitted On': 'header label - visible with data', 'SURVEY JSDP PAKET 6  PEKERJAAN DETAIL': 'header label - visible with data', 'SURVEY JSDP PAKET 6  PEKERJAAN DETAIL (PIPA TERJACKING) - specify': 'header label - visible with data', 'SURVEY JSDP PAKET 6  PEKERJAAN DETAIL (DC) - specify': 'header label - visible with data', 'SURVEY JSDP PAKET 6  PEKERJAAN DETAIL (MANHOLE) - specify': 'header label - visible with data', 'SURVEY JSDP PAKET 6  PROGRES PEKERJAAN': 'header label - visible with data', 'SURVEY JSDP PAKET 6  PROGRES PEKERJAAN (SUDAH SELESAI) - specify': 'header label - visible with data', 'SURVEY JSDP PAKET 6  PROGRES PEKERJAAN (DALAM PROSES) - specify': 'header label - visible with data', 'SURVEY JSDP PAKET 6  FOTO KONDISI PEKERJAAN': 'header label - visible with data', 'SURVEY JSDP PAKET 6  FOTO KONDISI LAPANGAN': 'header label - visible with data', 'SURVEY JSDP PAKET 6  CATATAN': 'header label - visible with data', });
