...
lyr_ShaftPaket5_9.set('fieldLabels', {'No.': 'hidden field', 'Lokasi': 'hidden field', 'ID Manhole (Upstream)': 'header label - always visible', 'ID Manhole (Downstream)': 'header label - always visible', 'Item Pek. Pipa Jacking': 'header label - always visible', 'Panjang Jacking (m)': 'header label - always visible', 'Status Pek. Pipa Jacking': 'header label - always visible', 'Item Pek. Konstruksi Shaft Vertikal': 'header label - always visible', 'Status Pek. Konstruksi Shaft Vertikal': 'header label - always visible', 'Item Pek. Manhole': 'header label - always visible', 'Status Pek. Manhole': 'header label - always visible', 'Item Pek. Perkerasan Kembali': 'header label - always visible', 'Status Pek. Perkerasan Kembali': 'header label - always visible', 'Keterangan': 'header label - always visible', 'Dokumentasi': 'header label - always visible', 'Longitude': 'hidden field', 'Latitude': 'hidden field', });
