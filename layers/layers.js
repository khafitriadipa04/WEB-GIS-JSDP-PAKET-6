...
var format_Jaringan_Perpipaan_5 = new ol.format.GeoJSON();
var features_Jaringan_Perpipaan_5 = format_Jaringan_Perpipaan_5.readFeatures(json_Jaringan_Perpipaan_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Jaringan_Perpipaan_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Jaringan_Perpipaan_5.addFeatures(features_Jaringan_Perpipaan_5);
var lyr_Jaringan_Perpipaan_5 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Jaringan_Perpipaan_5, 
                style: style_Jaringan_Perpipaan_5,
                popuplayertitle: 'Jaringan_Perpipaan',
                interactive: true,
    title: 'Jaringan_Perpipaan<br />\
    <img src="styles/legend/Jaringan_Perpipaan_5_0.png" /> Dia. 1000mm<br />\
    <img src="styles/legend/Jaringan_Perpipaan_5_1.png" /> Dia. 400mm<br />\
    <img src="styles/legend/Jaringan_Perpipaan_5_2.png" /> Dia. 450mm<br />\
    <img src="styles/legend/Jaringan_Perpipaan_5_3.png" /> Dia. 600mm<br />\
    <img src="styles/legend/Jaringan_Perpipaan_5_4.png" /> Dia. 800mm<br />\
    <img src="styles/legend/Jaringan_Perpipaan_5_5.png" /> Pipa PK3<br />' });
...
lyr_GoogleSatellite_0.setVisible(true);lyr_GoogleSatelliteHybrid_1.setVisible(true);lyr_jakarta_utara_2.setVisible(true);lyr_jakarta_barat_3.setVisible(true);lyr_TITIK_JSDP_4.setVisible(true);lyr_Jaringan_Perpipaan_5.setVisible(true);lyr_Pemantauanlingkunganpaket6_6.setVisible(true);
var layersList = [lyr_GoogleSatellite_0,lyr_GoogleSatelliteHybrid_1,lyr_jakarta_utara_2,lyr_jakarta_barat_3,lyr_TITIK_JSDP_4,lyr_Jaringan_Perpipaan_5,lyr_Pemantauanlingkunganpaket6_6];
...
lyr_TITIK_JSDP_4.set('fieldAliases', {'OID_': 'OID_', 'Name': 'Name', 'FolderPath': 'FolderPath', 'SymbolID': 'SymbolID', 'AltMode': 'AltMode', 'Base': 'Base', 'Snippet': 'Snippet', 'PopupInfo': 'PopupInfo', 'HasLabel': 'HasLabel', 'LabelID': 'LabelID', 'x': 'x', 'y': 'y', });
lyr_Jaringan_Perpipaan_5.set('fieldAliases', {'OID_': 'OID_', 'Name': 'Name', 'FolderPath': 'FolderPath', 'SymbolID': 'SymbolID', 'AltMode': 'AltMode', 'Base': 'Base', 'Clamped': 'Clamped', 'Extruded': 'Extruded', 'Snippet': 'Snippet', 'PopupInfo': 'PopupInfo', 'Shape_Leng': 'Shape_Leng', });
...
lyr_TITIK_JSDP_4.set('fieldImages', {'OID_': 'TextEdit', 'Name': 'TextEdit', 'FolderPath': 'TextEdit', 'SymbolID': 'TextEdit', 'AltMode': 'Range', 'Base': 'TextEdit', 'Snippet': 'TextEdit', 'PopupInfo': 'TextEdit', 'HasLabel': 'Range', 'LabelID': 'TextEdit', 'x': 'TextEdit', 'y': 'TextEdit', });
lyr_Jaringan_Perpipaan_5.set('fieldImages', {'OID_': 'TextEdit', 'Name': 'TextEdit', 'FolderPath': 'TextEdit', 'SymbolID': 'TextEdit', 'AltMode': 'Range', 'Base': 'TextEdit', 'Clamped': 'Range', 'Extruded': 'Range', 'Snippet': 'TextEdit', 'PopupInfo': 'TextEdit', 'Shape_Leng': 'TextEdit', });
...
lyr_TITIK_JSDP_4.set('fieldLabels', {'OID_': 'no label', 'Name': 'inline label - visible with data', 'FolderPath': 'no label', 'SymbolID': 'no label', 'AltMode': 'no label', 'Base': 'no label', 'Snippet': 'no label', 'PopupInfo': 'no label', 'HasLabel': 'no label', 'LabelID': 'no label', 'x': 'no label', 'y': 'no label', });
lyr_Jaringan_Perpipaan_5.set('fieldLabels', {'OID_': 'no label', 'Name': 'inline label - visible with data', 'FolderPath': 'no label', 'SymbolID': 'no label', 'AltMode': 'no label', 'Base': 'no label', 'Clamped': 'no label', 'Extruded': 'no label', 'Snippet': 'no label', 'PopupInfo': 'no label', 'Shape_Leng': 'no label', });
